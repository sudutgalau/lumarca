...
import lumarca.program.IndividualLineDepthProgram;
...
public class Lumarca extends PApplet {
	...
	private enum PROGRAM {
		...
		LineProgram eval(Lumarca lumarca) {
			...
			case SHOW:
				return new Siggraph(lumarca);//ShowProgram(lumarca);
			case GAME:
			...
			case CAM:
				return new HearProgram(lumarca);
			case MUDTUB:
				return new ColorVortexProgram(lumarca);//MudTub(lumarca);
			case VORTEX:
...
//		currentProgram = new PlayMovieProgram(this);
		...
		iwp = new IndividualLineDepthProgram(this);
...
//		}
	...
	public static void main(String _args[]) {
		PApplet.main(new String[] { lumarca.Lumarca.class.getName()  });
	}
